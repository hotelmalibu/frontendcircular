...
const COLOR_AMARILLO_CONSUMO = '#E8AD00'; // Amarillo de Pedagogía/Consumo
  ...
  return (
    ...
    <div className="mt-24 font-sans min-h-screen" style={{ backgroundImage: `url(${fondos_submenus})`, backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <div className="px-6 md:px-24 pb-14 max-w-7xl mx-auto">
        ...
        {/* 2. CONTENIDO PRINCIPAL: Tarjeta de Consumo Responsable */}
        <div className="flex flex-col lg:flex-row items-start gap-8 bg-white p-6 md:p-10 rounded-xl shadow-xl border-t-4" style={{ borderColor: COLOR_AMARILLO_CONSUMO }}>
          ...
          <div className="w-full lg:w-2/3 text-lg font-sans text-left self-center">
            <p className="text-gray-800 leading-relaxed text-2xl mb-4">
              Sensibilizar y contribuir al cambio de hábitos y
              comportamiento del consumidor fomentando la
        ...
        <section 
          ...
          style={{ borderColor: COLOR_AMARILLO_CONSUMO }} // <-- Borde superior Amarillo
        >
          <h2 className="text-3xl font-sans font-bold mb-4" style={{ color: COLOR_AZUL_PRINCIPAL }}>
            Enfoque y Alcance de la Línea
          </h2>
          <p className="text-xl text-gray-700 leading-relaxed">
            *Esta línea se centra en la educación y concientización del consumidor final sobre la importancia de la correcta separación y disposición de residuos para el ciclo de la economía circular.
          </p>
        </section>
