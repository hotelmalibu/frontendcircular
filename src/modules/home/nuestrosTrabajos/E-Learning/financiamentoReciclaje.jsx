...
import Index from "../../../../components/home/nuestrosTrabajos/E-Learning/financiamentoReciclaje/index.jsx";

export default function FinanciamientoReciclaje() {
  return (
    <div className="mt-24 px-6 py-14 text-center" style={{ backgroundImage: `url(${fondos_submenus})`, backgroundSize: "cover", backgroundPosition: "center" }}>
      <h1 className="text-3xl font-bold mb-4">Financiamiento del Reciclaje</h1>
