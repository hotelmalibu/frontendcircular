...
export default function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || "No se pudo actualizar la contraseña. Reinténtalo.");
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden flex-col justify-between p-12 text-white"
                ...
                <div className="relative z-10 mb-24">
                    <h1 className="text-5xl font-bold leading-tight mb-6">
                        Nueva <span style={{ color: BRAND.green }}>Contraseña</span>.
                    </h1>
                    ...
                    {!isSuccess ? (
                        <>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                {/* Email (solo lectura para feedback) */}
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-gray-700 ml-1">Para el usuario</label>
                                    <input 
                                        type="text" 
                                        value={email} 
                                        disabled 
                                ...
                                {/* Nueva Contraseña */}
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-gray-700 ml-1">Nueva Contraseña</label>
                        ...
                        <div className="text-center animate-fadeIn">
                            ...
                            <h2 className="text-3xl font-bold text-gray-900 mb-4">¡Contraseña Cambiada!</h2>
